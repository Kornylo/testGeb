...
class CareLinkSpec extends GebReportingSpec implements IGlobalExtension{
    ...
    void visitSpec(SpecInfo specInfo)
    {
        ...
        specInfo.addListener(new com.kornylo.test.geb.runlisteners.ReportiumRunListener(reportiumClient))
    }

    void start() {}
    void stop() {}
    private void setupRunListeners(){
        specificationContext.currentSpec.addListener(new com.kornylo.test.geb.runlisteners.ReportiumRunListener(reportiumClient))
    }
